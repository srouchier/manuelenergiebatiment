...
* On commence par y donner un aperçu des principales sources de chaleur et de déperditions thermiques en présentant l'exemple de bilan thermique d'un bâtiment.
* Ensuite, on présente les hypothèses principales prises par le calcul réglementaire RE 2020 pour formuler ce bilan thermique et calculer les besoins de chauffage et de refroidissement.
* Enfin, la section \@ref(apercu1) annonce la description plus détaillée qui sera faite des transferts thermiques dans les chapitres suivants.
